...
const sortOptions = computed(() => [
  { value: 'downloads-week-desc' as const, label: t('filters.sort.downloads_week') },
  { value: 'updated-desc' as const, label: t('filters.sort.published') },
  { value: 'name-asc' as const, label: t('filters.sort.name') },
])
